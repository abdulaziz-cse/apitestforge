    ...
    <div id="topbar">
      <div class="container">
        <div class="social-links">
          <a href="https://www.instagram.com/rmcr8500/" class="twitter"><i class="fab fa-twitter"></i></a>
          <a href="https://twitter.com/rmcr8500" class="instagram"><i class="fab fa-instagram"></i></a>

        </div>

        <div class="social-phone">
            <a href="#" class="phone"><i class="fas fa-headphones-alt"></i> 920008500 </a>
          </div>
    ...
    <div class="container d-flex h-100">
      ...
      <div class="row justify-content-center align-self-center">
        ...
        <div class="col-md-6 intro-img order-md-last order-first">
          <img src="img/logo4.png" alt="" class="img-fluid">
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-md-6">
            <div class="about-content">
              <h2>حول المركز  ؟ </h2>
              <h3> يعد مركز الرياض الطبي منظومة متكاملة، حيث يضم مراكز تخصصية توفر خيارات الرعاية الصحية والتأهيلية. ويتشرف فريقنا الطبي بتقديم الخدمات الصحية على أيدي أطباً من الحاصلين على أرقى الدرجات العلمية  في أكثر من  تخصصاً </h3>
              <p> </p>
              <p>  </p>
                                ...
                                <div id="check1" class="panel-collapse collapse in">
                                  <div class="panel-body">
                                    <p>
                                        <ul> اشعة اسنان</ul>
                                        <ul>علاج اللثة</ul>
                                        <ul>تبطين طقم اسنان كامل</ul>
                                        <ul>حافظ مسافة جهة واحدة</ul>
                                        <ul>طقم اسنان كامل ( علوي – سفلي)</ul>
                                        <ul>تلبيسة بلاستيك امامي</ul>
                                        <ul>فنير المشاهير</ul>
                                        <ul>تنظيف الجير</ul>
                                        <ul>تبييض اسنان بجهاز Z6 دورتين</ul>
              ...
              <div class="features wow bounceInUp clearfix">
                ...
                <div class="panel panel-default">
                  ...
                  <div id="check2" class="panel-collapse collapse">
                    <div class="panel-body">
                      <p>
                        <ul>إزالة الزوائد الجلدية – الثاليل</ul>
                        <ul>الاكزيما البنيويه</ul>
                        <ul>الثاليل التناسليه</ul>
                        <ul>الطفح الجلدي</ul>
                        <ul>تساقط الشعر</ul>
                        <ul>الحكة الشديدة</ul>
                        <ul>الطفح الجلدي</ul>
    ...
    <section id="faq">
      <div class="container">
        ...
        <ul id="faq-list" class="wow fadeInUp">
          <li>
            <a data-toggle="collapse" class="collapsed" href="#faq1"> سؤال ١ <i class="ion-android-remove"></i></a>
          ...
          <li>
            <a data-toggle="collapse" href="#faq2" class="collapsed">سؤال ٢  <i class="ion-android-remove"></i></a>
...
جواب ٢
          ...
          <li>
            <a data-toggle="collapse" href="#faq3" class="collapsed"> سوال ٣ <i class="ion-android-remove"></i></a>
...
جواب           ٣
          ...
          <li>
            <a data-toggle="collapse" href="#faq4" class="collapsed">سوال ٤  <i class="ion-android-remove"></i></a>
...
جواب ٤
          ...
          <li>
            <a data-toggle="collapse" href="#faq5" class="collapsed">سوال ٥ <i class="ion-android-remove"></i></a>
...
جواب ٥               </p>
          ...
          <li>
            <a data-toggle="collapse" href="#faq6" class="collapsed">سوال ٦  <i class="ion-android-remove"></i></a>
  ...
  <footer id="footer" class="section-bg">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="footer-links">
                    <h4>القوائم المهمة</h4>
                    <ul>
                        <li><a href="#intro">الرئسية</a></li>
                        <li><a href="#faq"> الاسئلة  الشائعة </a></li>
                        <li><a href="#services">الاقسام الطبية</a></li>
                        <li><a href="#about">حول المركز</a></li>
                    </ul>
                  ...
                  <div class="footer-links">
                    <h4>أين تجدنا </h4>
                    <p>
                      شارع الثلاثين الجنوبي <br>
                      حائل, حي المطار <br>
                      المملكة العربية السعودية <br>
                      <strong> هاتف :</strong> 920008500 <br>
                      <strong> info@rmcr8500.com : </strong> بريد الالكتروني   <br>
          ...
          <div class="col-lg-6">
            ...
            <div class="form">
              ...
              <form action="" method="post" role="form" class="contactForm">
                ...
                <div class="form-group">
                  <input type="email" class="form-control" name="email" id="email" placeholder="بريد الالكتروني" data-rule="email" data-msg="Please enter a valid email" />
                  <div class="validation"></div>
                </div>
                <div class="form-group">
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://api.whatsapp.com/send?phone=966531437350&text=أنا عبدالعزيز العبدلي">AB</a>
      </div>
    </div>
  </footer><!-- #footer -->
